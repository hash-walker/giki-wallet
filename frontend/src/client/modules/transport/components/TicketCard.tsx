...
import { Ticket, Bus, MapPin, Calendar, User, Loader2, Hash, Clock, Navigation } from 'lucide-react';
                        ...
                        <div className="flex items-center justify-between pt-2">
                            ...
                            {canCancel && (
                                <button
                                    ...
                                    className="px-4 py-2 bg-slate-50 text-destructive text-[10px] font-black uppercase tracking-widest rounded-lg border border-transparent hover:border-destructive/20 hover:bg-destructive/5 transition-all disabled:opacity-50 flex items-center gap-2"
                                >
